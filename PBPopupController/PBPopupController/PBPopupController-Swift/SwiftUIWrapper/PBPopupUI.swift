...
public extension View {
    ...
    /// - Returns: A popup bar view.
    func popup(isPresented: Binding<Bool>, isOpen: Binding<Bool>? = nil, isHidden: Binding<Bool>? = nil, onPresent: (() -> Void)? = nil, onDismiss: (() -> Void)? = nil, onOpen: (() -> Void)? = nil, onClose: (() -> Void)? = nil, willPresent: (() -> Void)? = nil, willDismiss: (() -> Void)? = nil, willOpen: (() -> Void)? = nil, willClose: (() -> Void)? = nil, popupControllerPanGestureShouldBegin: ((PBPopupController, PBPopupPresentationState) -> Bool)?, popupContentController: UIViewController) -> some View {
